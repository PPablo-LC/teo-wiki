...
description: "El error en la Biblia: de la idolatría y el extravío del AT al escándalo de la cruz en el NT, y la lucha contra las enseñanzas erróneas."
tags: ["resumen", "vocabulario bíblico"]
---

# Error

> 📄 **Fuente original:** `error.md`

## Conceptos básicos referenciados

- [[fidelidad]] — el error como infidelidad
...
El error no equivale a la ignorancia. No consiste en los titubeos de la inteligencia. No se reduce a la equivocación ante las apariencias *Gen 20,2-7*, ni a la inadvertencia *Lev 4,2*. El error es ante todo [[fidelidad|infidelidad]], consiste en rechazar la [[verdad]]. Vagar por el mundo será su efecto y su [[castigos|castigo]]: Caín vagabundo *Gen 4,12*, Israel errante *Os 9,17*, las ovejas sin pastor *Is 53,6*, que hay que devolver al aprisco *Lc 15,4-7* *1Pe 2,25*.
